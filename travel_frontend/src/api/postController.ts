...
export async function updatePostTags(
  ...
  return request<API.ResponseDTOBoolean>(`/post/${param0}/tags`, {
    method: 'POST',
    headers: {
...
export async function addPost(body: API.PostAddRequest, options?: { [key: string]: any }) {
  return request<API.ResponseDTOLong>('/post/add', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getPostById(
  ...
  return request<API.ResponseDTOPostVO>(`/post/get/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  })
...
export async function listPostByCategory(
  ...
  return request<API.ResponseDTOPagePost>('/post/list/byCategory', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listPostByPage(body: API.PostQueryRequest, options?: { [key: string]: any }) {
  return request<API.ResponseDTOPagePost>('/post/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getAllTags(options?: { [key: string]: any }) {
  return request<API.ResponseDTOListTag>('/post/tags/all', {
    method: 'GET',
    ...(options || {}),
  })
}
