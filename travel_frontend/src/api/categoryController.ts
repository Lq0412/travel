...
export async function addCategory(body: API.Category, options?: { [key: string]: any }) {
  return request<API.ResponseDTOInteger>('/category/add', {
    method: 'POST',
    headers: {
...
export async function deleteCategory(
  ...
  return request<API.ResponseDTOBoolean>(`/category/delete/${param0}`, {
    method: 'POST',
    params: { ...queryParams },
    ...(options || {}),
  })
...
export async function getCategoryById(
  ...
  const { id: param0, ...queryParams } = params
  return request<API.ResponseDTOCategory>(`/category/get/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  })
...
export async function listAllCategories(options?: { [key: string]: any }) {
  return request<API.ResponseDTOListCategory>('/category/list', {
    method: 'GET',
    ...(options || {}),
  })
}
...
export async function updateCategory(body: API.Category, options?: { [key: string]: any }) {
  return request<API.ResponseDTOBoolean>('/category/update', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
