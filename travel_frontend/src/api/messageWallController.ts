...
export async function addMessage(body: API.MessageWallDTO, options?: { [key: string]: any }) {
  return request<API.ResponseDTOMessageWallVO>('/message/wall/add', {
    method: 'POST',
    headers: {
...
export async function cancelLikeMessage(
  ...
  return request<API.ResponseDTOBoolean>(`/message/wall/cancelLike/${param0}`, {
    method: 'POST',
    params: { ...queryParams },
    ...(options || {}),
  })
...
export async function deleteMessage(
  ...
  const { messageId: param0, ...queryParams } = params
  return request<API.ResponseDTOBoolean>(`/message/wall/delete/${param0}`, {
    method: 'POST',
    params: { ...queryParams },
    ...(options || {}),
  })
...
export async function likeMessage(
  ...
  const { messageId: param0, ...queryParams } = params
  return request<API.ResponseDTOBoolean>(`/message/wall/like/${param0}`, {
    method: 'POST',
    params: { ...queryParams },
    ...(options || {}),
  })
...
export async function listMessages(
  ...
  return request<API.ResponseDTOPageMessageWallVO>('/message/wall/list', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getAllScenicMessageWalls(options?: { [key: string]: any }) {
  return request<API.ResponseDTOListScenicMessageWallVO>('/message/wall/list/all', {
    method: 'GET',
    ...(options || {}),
  })
}
...
export async function reviewMessage(
  ...
  const { messageId: param0, ...queryParams } = params
  return request<API.ResponseDTOBoolean>(`/message/wall/review/${param0}`, {
    method: 'POST',
    params: {
      ...queryParams,
    },
...
export async function createScenicMessageWall(
  ...
  return request<API.ResponseDTOScenicMessageWallVO>('/message/wall/scenic/create', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function updateScenicMessageWall(
  ...
  return request<API.ResponseDTOScenicMessageWallVO>('/message/wall/scenic/update', {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
