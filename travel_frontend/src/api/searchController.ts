...
export async function searchPosts(body: API.PostQueryRequest, options?: { [key: string]: any }) {
  return request<API.ResponseDTOPagePostVO>('/search/posts', {
    method: 'POST',
    headers: {
...
export async function searchPostsByTag(
  ...
  return request<API.ResponseDTOPagePostVO>('/search/posts/by-tag', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function searchPostsByTagId(
  ...
  return request<API.ResponseDTOPagePostVO>('/search/posts/by-tag-id', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function searchPostsByTagIds(
  ...
  return request<API.ResponseDTOPagePostVO>('/search/posts/by-tag-ids', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function searchPostsByTagNames(
  ...
  return request<API.ResponseDTOPagePostVO>('/search/posts/by-tag-names', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function searchTags(
  ...
  return request<API.ResponseDTOListTag>('/search/tags', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function getTagsByPostId(
  ...
  return request<API.ResponseDTOListTag>(`/search/tags/by-post/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  })
...
export async function getHotTags(
  ...
  return request<API.ResponseDTOListTag>('/search/tags/hot', {
    method: 'GET',
    params: {
