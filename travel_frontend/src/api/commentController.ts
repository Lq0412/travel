...
export async function addComment(body: API.CommentAddRequest, options?: { [key: string]: any }) {
  return request<API.ResponseDTOBoolean>('/comment/add', {
    method: 'POST',
    headers: {
...
export async function deleteComment(
  ...
  return request<API.ResponseDTOBoolean>('/comment/delete', {
    method: 'POST',
    params: {
      ...params,
    },
...
export async function listCommentByPage(
  ...
  return request<API.ResponseDTOPageComment>('/comment/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function addReply(body: API.CommentAddRequest, options?: { [key: string]: any }) {
  return request<API.ResponseDTOBoolean>('/comment/reply/add', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listRepliesByPage(
  ...
  return request<API.ResponseDTOPageComment>('/comment/reply/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function updateComment(body: API.Comment, options?: { [key: string]: any }) {
  return request<API.ResponseDTOBoolean>('/comment/update', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
