...
export async function favoritePost(body: API.LikeRequest, options?: { [key: string]: any }) {
  return request<API.ResponseDTOBoolean>('/interaction/favorite/post', {
    method: 'POST',
    headers: {
...
export async function checkPostFavorite(
  ...
  return request<API.ResponseDTOBoolean>('/interaction/favorite/post/check', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function likeComment(body: API.CommentLikeRequest, options?: { [key: string]: any }) {
  return request<API.ResponseDTOBoolean>('/interaction/like/comment', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function checkCommentLike(
  ...
  return request<API.ResponseDTOBoolean>('/interaction/like/comment/check', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function likePost(body: API.LikeRequest, options?: { [key: string]: any }) {
  return request<API.ResponseDTOBoolean>('/interaction/like/post', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function checkPostLike(
  ...
  return request<API.ResponseDTOBoolean>('/interaction/like/post/check', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function getLatestPosts(body: API.PostQueryRequest, options?: { [key: string]: any }) {
  return request<API.ResponseDTOPagePost>('/interaction/posts/latest', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getMostCommentedPosts(
  ...
  return request<API.ResponseDTOPagePost>('/interaction/posts/most-commented', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getMostLikedPosts(
  ...
  return request<API.ResponseDTOPagePost>('/interaction/posts/most-liked', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function getMostViewedPosts(
  ...
  return request<API.ResponseDTOPagePost>('/interaction/posts/most-viewed', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function unfavoritePost(body: API.LikeRequest, options?: { [key: string]: any }) {
  return request<API.ResponseDTOBoolean>('/interaction/unfavorite/post', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function unlikeComment(
  ...
  return request<API.ResponseDTOBoolean>('/interaction/unlike/comment', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function unlikePost(body: API.LikeRequest, options?: { [key: string]: any }) {
  return request<API.ResponseDTOBoolean>('/interaction/unlike/post', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
