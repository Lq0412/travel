...
export async function chatSimple(body: Record<string, any>, options?: { [key: string]: any }) {
  return request<API.ResponseDTOMapStringObject>('/digital-human/chat-simple', {
    method: 'POST',
    headers: {
...
export async function test(options?: { [key: string]: any }) {
  return request<API.ResponseDTOMapStringObject>('/digital-human/test', {
    method: 'GET',
    ...(options || {}),
  })
}
...
export async function getVoices(options?: { [key: string]: any }) {
  return request<API.ResponseDTOMapStringObject>('/digital-human/voices', {
    method: 'GET',
    ...(options || {}),
  })
}
