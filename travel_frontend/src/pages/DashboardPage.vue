...
const getSectionIcon = () => {
  ...
  const icons = {
    // 统一切换为蓝色描边图标
    'admin': 'https://unpkg.com/lucide-static@latest/icons/trending-up.svg?color=%232f54eb',
    'merchant': 'https://unpkg.com/lucide-static@latest/icons/shopping-bag.svg?color=%232f54eb',
    'user': 'https://unpkg.com/lucide-static@latest/icons/sparkles.svg?color=%232f54eb'
  }
...
.welcome-banner {
  ...
  background: linear-gradient(135deg, var(--accent-50) 0%, var(--secondary-50) 100%);
  ...
  &::before {
    ...
    width: 300px;
    height: 300px;
    background: radial-gradient(circle, rgba(255, 192, 51, 0.08) 0%, transparent 70%);
    border-radius: 50%;
  }
