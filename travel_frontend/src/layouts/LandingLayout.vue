...
const handleLogout = async () => {
  try {
    ...
    const shouldForceLogout = code === 0 || code === 200 || code === 401 || code === 40100 || code === 50001
    if (shouldForceLogout) {
      loginUserStore.setLoginUser({ id: undefined, userName: '未登录', userAvatar: '', userAccount: '', userRole: undefined as any })
...
.landing-layout {
  ...
  background: linear-gradient(180deg, rgba(59, 110, 220, 0.14) 0%, rgba(47, 144, 240, 0.08) 35%, var(--color-bg) 100%);
}
...
.btn-register {
  ...
  &:hover {
    ...
    box-shadow: 0 8px 20px rgba(47, 144, 240, 0.3);
  }
}
...
.dropdown-item {
  ...
  &.danger {
    &:hover {
      background: rgba(219, 80, 74, 0.18);
