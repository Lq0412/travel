...
) ENGINE = InnoDB AUTO_INCREMENT = 1991506057576181762 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI对话表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1991506070679187459 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI消息表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `memory_card_history`  (
  ...
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE,
  INDEX `idx_is_delete`(`is_delete` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '回忆图历史表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `picture`  (
  ...
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1973989138267475977 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '图片' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 791 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '帖子表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 41 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '帖子与标签的关联关系' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '系统标签库' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '行程表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `trip_photo`  (
  ...
  INDEX `idx_is_delete`(`is_delete` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '行程照片表' ROW_FORMAT = DYNAMIC;
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1971813431033851906, 'lqlq', '44350efcdd5b9e59474990ea87c46a2e', '66666', 'https://qq-1375584552.cos.ap-guangzhou.myqcloud.com/public/1971813431033851906/2025-11-20_0ORWh2ZeA44UYw11.webp', '我是子聪', 'admin', '2025-09-27 13:45:31', '2025-09-27 13:45:31', '2025-11-20 22:01:40', 0);
