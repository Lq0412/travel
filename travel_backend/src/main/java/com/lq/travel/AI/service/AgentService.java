...
public interface AgentService {
     ...
     * 流式执行代理任务
     */
    void executeAgentStream(String agentName, AgentRequest request, com.lq.travel.AI.interfaces.StreamCallback callback);

    /**
     * 流式执行代理任务（带会话ID），便于缓存与聊天历史保存
     */
    void executeAgentStream(String agentName, AgentRequest request, Long conversationId, com.lq.travel.AI.interfaces.StreamCallback callback);
}
