...
public final class AiMqConstants {
    ...
    public static final String QUEUE_MEMORY_CARD = "ai.task.memory-card";
    ...
    public static final String QUEUE_MEMORY_CARD_DLQ = "ai.task.memory-card.dlq";
    ...
    public static final String ROUTING_MEMORY_CARD = "MEMORY_CARD";
